...
def f(fragment_path, output_path, num_fts, keypoint_radius, r_vals, n_keypoints, k, lbd, nms, nms_rad, useflags):
    extractor = Extractor(
        fragment_path, output_path, num_fts, keypoint_radius, r_vals, n_keypoints, k, lbd, nms, nms_rad, useflags
    )
    extractor.extract()
